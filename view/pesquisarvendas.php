...
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <title>MiniappLoja | Pesquisar Vendas</title>
    ...
    <body>
        ...
        <!-- Seção Destinada a Pesquisa de Vendas -->
        <section id="pesquisavenda-view">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="pesquisavenda-view-area">
                            <div class="pesquisavenda-view-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <input type="text" name="" id="" placeholder="Digite o ID da Venda">
                                                        <button type="submit"><span class="fa fa-search"></span></button>
                                                    </th>
                                                    <th>
                                                        <input type="text" name="" id="" placeholder="Digite a Data">
                                                        <button type="submit"><span class="fa fa-search"></span></button>
                                                    </th>
                                                    <th>
                                                        <input type="text" name="" id="" placeholder="Digite o Preço Total">
                                                        <button type="submit"><span class="fa fa-search"></span></button>
                                                    </th>
                                                </tr>
                                            </thead>
