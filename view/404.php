...
<html lang="pt-br">
    <head>
        <meta charset="utf-8">
        <title>MiniappLoja | ERROR 404</title>
    ...
    <body>
        ...
        <!-- Seção Destinada ao Error 404 - Página Não Encontrada -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="aa-error-area">
                            <h2>404</h2>
                            <span>Oh oh :( Página Não Encontrada</span>
                            <p>Desculpe mas o conteúdo solicitado foi movido para outro destino ou não existe mais.</p>
                            <a href="paginainicial.php"> Ir para a Página Inicial</a>
                        </div>
                    </div>
                </div>
            </div>
